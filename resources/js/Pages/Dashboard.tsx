        ...
        >
            ...
            <style>{`
                ...
                @keyframes glow {
                    ...
                    50% { box-shadow: 0 0 30px rgba(251, 191, 36, 0.8), 0 0 40px rgba(251, 191, 36, 0.3); }
                }
                ...
                @keyframes shadowDance {
                    0%, 100% { box-shadow: 0 10px 30px rgba(0, 0, 0, 0.8); }
                    50% { box-shadow: 0 20px 40px rgba(0, 0, 0, 0.9), 0 0 20px rgba(139, 69, 19, 0.3); }
                }
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <Card className="group transition-all duration-500 hover:shadow-2xl hover:-translate-y-3 border-3 border-emerald-600 bg-gradient-to-b from-stone-800 to-emerald-950 shadow-dance hover:border-emerald-400">
                            ...
                            <CardContent className="text-stone-200">
                                ...
                                <Button variant="outline" className="w-full border-2 border-emerald-500 text-emerald-300 hover:bg-emerald-900 bg-emerald-950">
                                    📖 Baca Grimoire →
                                </Button>
                            </CardContent>
                        </Card>
