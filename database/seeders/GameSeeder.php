...
class GameSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create Mission 2 - Fun Logic Challenges (Level 2 untuk SD-SMP)
        ...
        // Stage 2A - Pattern Recognition (Mudah untuk anak)
        Stage::create([
            'mission_id' => $mission2->id,
            'name' => 'Mencari Pola Angka',
            'config' => [
                'timeLimit' => 300, // 5 menit lebih lama
                'difficulty' => 'mudah',
                'learningObjectives' => [
                    ...
                    [
                        ...
                        'sequences' => [
                            [
                                'id' => 1,
                                'pattern' => [1, 2, 3, 4, '?'],
                                'rule' => 'Angka naik satu-satu',
                                'answer' => 5,
                                'category' => 'menghitung_sederhana'
                            ],
                            [
                                'id' => 2,
                                'pattern' => [2, 4, 6, 8, '?'],
                                'rule' => 'Angka naik dua-dua',
                                'answer' => 10,
                                'category' => 'kelipatan_dua'
                            ],
                            [
                                'id' => 3,
                                'pattern' => [5, 10, 15, 20, '?'],
                                'rule' => 'Angka naik lima-lima',
                                'answer' => 25,
                                'category' => 'kelipatan_lima'
                            ],
                            [
                                'id' => 4,
                                'pattern' => [10, 20, 30, 40, '?'],
                                'rule' => 'Angka naik sepuluh-sepuluh',
                                'answer' => 50,
                                'category' => 'kelipatan_sepuluh'
                            ]
                        ],
                        'hints' => [
        ...
        // Stage 2B - Simple Logic (Logika sederhana)
        Stage::create([
            'mission_id' => $mission2->id,
            'name' => 'Tebak Kode Rahasia',
            'config' => [
                'timeLimit' => 240,
                'difficulty' => 'mudah',
                'learningObjectives' => [
                ...
                'puzzles' => [
                    [
                        ...
                        'codeSnippet' => [
                            ...
                            '3. Bandingkan: 5 lebih besar dari 3?', // Ini benar
                            '4. Jadi 5 harus di belakang 3', // Ini salah - seharusnya di depan
                            '5. Hasil: 3, 5'
                        ],
                        'testInput' => [5, 3],
                        'expectedOutput' => [3, 5],
        ...
        // Stage 2C - Simple Tree Navigation (Navigasi pohon sederhana)
        Stage::create([
            'mission_id' => $mission2->id,
            'name' => 'Jelajahi Pohon Angka',
            'config' => [
                'timeLimit' => 360,
                'difficulty' => 'mudah',
                'learningObjectives' => [
                ...
                'puzzles' => [
                    [
                        ...
                        'challenges' => [
                            [
                                'task' => 'Cari jalan ke angka 7',
                                'answer' => ['root', 'left', 'right'],
                                'explanation' => 'Mulai dari 10, ke kiri jadi 5, lalu ke kanan jadi 7'
                            ],
                            [
                                'task' => 'Cari jalan ke angka 12',
                                'answer' => ['root', 'right', 'left'],
                                'explanation' => 'Mulai dari 10, ke kanan jadi 15, lalu ke kiri jadi 12'
                            ]
                        ],
                        'traversalMethods' => [
        ...
        // Stage 2D - Fun Color Pattern (Pola warna untuk variasi)
        Stage::create([
            'mission_id' => $mission2->id,
            'name' => 'Pola Warna Seru',
            'config' => [
                'timeLimit' => 240,
                'difficulty' => 'mudah',
                'learningObjectives' => [
                    ...
                    [
                        ...
                        'sequences' => [
                            [
                                ...
                                'rule' => 'Merah dan Biru bergantian',
                                'answer' => 'Merah',
                                'category' => 'pola_bergantian'
                            ],
                            [
                                'id' => 2,
                                'pattern' => ['Hijau', 'Hijau', 'Kuning', 'Hijau', 'Hijau', '?'],
                                'rule' => 'Dua Hijau, satu Kuning, berulang',
                                'answer' => 'Kuning',
                                'category' => 'pola_berulang'
                            ]
                        ],
                        'hints' => [
