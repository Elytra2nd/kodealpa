  ...
  return (
    ...
    >
      ...
      <div className="space-y-8">
        ...
        <div
          className="fixed inset-0 opacity-10 bg-repeat pointer-events-none"
          style={{
        ...
        <div className="relative overflow-hidden border-4 border-amber-700 shadow-dance bg-gradient-to-br from-stone-800 via-amber-900 to-stone-900 rounded-2xl">
