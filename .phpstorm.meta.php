...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\kodealpa\public\storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\kodealpa\\public\\storage','logging.default',
...
'profile.edit','profile.update','profile.destroy','game.lobby','game.session',
'game.analytics','game.results','game.tournament.lobby','game.tournament.session','game.tournament.leaderboard',
'game.tournament.bracket','game.tournament.history','game.tournament.spectate','game.tournament.analytics','voice.lobby',
'voice.test','voice.settings','stage1','grimoire.panel','grimoire.editor',
'grimoire.view','game.grimoire','game.journal','game.journal.detail','game.achievements',
'api.stages.index','api.stages.show','api.sessions.create','api.sessions.join','api.sessions.start',
'api.sessions.state','api.sessions.attempt','api.sessions.hint','api.sessions.feedback','api.sessions.analytics',
'api.sessions.pause','api.sessions.resume','api.sessions.end','api.sessions.participants','api.sessions.participants.remove',
'api.sessions.progress','api.sessions.progress.update','api.tournaments.index','api.tournaments.create','api.tournaments.show',
'api.tournaments.join','api.tournaments.leave','api.tournaments.session','api.tournaments.session.complete','api.tournaments.leaderboard',
'api.tournaments.bracket','api.tournaments.status','api.tournaments.analytics','api.tournaments.start','api.tournaments.pause',
'api.tournaments.resume','api.tournaments.cancel','api.tournaments.groups','api.tournaments.groups.kick','api.tournaments.spectate',
'api.tournaments.active','api.tournaments.upcoming','api.tournaments.completed','api.tournaments.stats.global','api.tournaments.stats.user',
'api.tournaments.history.user','api.grimoire.categories','api.grimoire.entries.index','api.grimoire.entries.show','api.grimoire.search',
'api.grimoire.entries.store','api.grimoire.entries.update','api.grimoire.entries.destroy','api.journal.index','api.journal.stats',
'api.journal.show','api.achievements.index','api.voice.token','api.voice.lobby.token','api.voice.session.token',
'api.voice.session.participants','api.voice.session.join','api.voice.session.leave','api.voice.session.status','api.voice.session.mute',
'api.voice.session.volume','api.voice.session.analytics','api.voice.session.report','api.voice.test.connection','api.voice.test.audio',
'api.voice.servers','api.voice.settings.get','api.voice.settings.update','api.voice.session.kick','api.voice.session.mute.user',
'api.voice.session.unmute.user','api.signaling.offer','api.signaling.answer','api.signaling.ice-candidate','api.signaling.status',
'ws.voice.session','ws.voice.lobby','ws.voice.status','ws.tournament.updates','ws.tournament.leaderboard',
'game.leaderboard','game.guide','game.history','game.settings','game.stats',
'game.tournament.guide','game.tournament.rules','game.tournament.stats','game.voice.tutorial','game.voice.troubleshoot',
'game.voice.feedback','game.voice.analytics','health.voice','health.signaling','health.voice.servers',
'health.tournaments','health.system','docs.voice.api','docs.webrtc.guide','docs.voice.troubleshoot',
'docs.tournament.api','docs.tournament.guide','docs.api','stream.tournament','stream.session',
'google.redirect','google.callback','register','login','password.request','password.email','password.reset','password.store',
...
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.laragon.www.kodealpa.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'VITE_HMR_HOST','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','APP_LOCALE',
